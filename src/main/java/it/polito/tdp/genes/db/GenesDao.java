...
public class GenesDao {
	...
	public List<String> getAllLocalizzazioni() {
		String sql = "select distinct Localization "
				+ "from classification order by Localization";
	...
	public List<Adiacenza> getArchi() {
		String sql = "select distinct c1.Localization as localization1,c2.Localization as localization2, COUNT(distinct i.`Type`) as peso "
		...
		try {
			...
			ResultSet res = st.executeQuery();
			while (res.next()) {
				result.add(new Adiacenza(res.getString("localization1"),res.getString("localization2"),res.getInt("peso")));
			}
			res.close();
			st.close();
			conn.close();
